...
/**
 * Abstract base class for all RVNKQuests commands.
 ...
 * - Integrated CommandExecutor and TabCompleter interfaces
 * - Permission checking with configurable permissions
 * - Subcommand registration and delegation
 * - Standardized help and error messaging
 */
