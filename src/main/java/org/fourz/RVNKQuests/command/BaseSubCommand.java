 ...
 * - Standardized permission checking with inheritance from parent
 * - Player-only command support
 * - Consistent error messaging and validation helpers
...
public abstract class BaseSubCommand implements SubCommand {
     ...
     */
    public BaseSubCommand(RVNKQuests plugin, RVNKCommand parent, String name, String description, 
     ...
     * @param usage The subcommand usage string
     */
    public BaseSubCommand(RVNKQuests plugin, RVNKCommand parent, String name, String description, String usage) {
    ...
    public BaseSubCommand(RVNKQuests plugin, String name, String description, String usage, 
        ...
        this(plugin, null, name, description, usage, permission, playerOnly);
    }
