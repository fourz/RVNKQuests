...
2. Deploy to dev server: `/rvnkdev-deploy <server_id> full`
3. Verify console output for errors: `/rvnkdev-query <server_id> errors`
4. Check plugin loads correctly: `/rvnkdev-query <server_id> plugin RVNKQuests`
